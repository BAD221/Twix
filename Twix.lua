...
local Get_Files, res = https.request("https://raw.githubusercontent.com/BAD221/Files_Twix/main/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/BAD221/Files_Twix/main/File_Bot/"..FileName)
if Res == 200 then
