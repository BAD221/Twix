...
--     Source Twix     --
local Hii3dRank = function(msg) if SudoId(msg.sender_user_id_) then F1itHTEAM  = "المطور" elseif SecondSudo(msg) then F1itHTEAM = "المطور" elseif SudoBot(msg) then F1itHTEAM = "المطور" elseif ManagerAll(msg) then F1itHTEAM = "المدير" elseif AdminAll(msg) then F1itHTEAM = "الادمن" elseif Hii3dConstructor(msg) then F1itHTEAM = "المنشئ" elseif BasicConstructor(msg) then F1itHTEAM = "المنشئ" elseif Constructor(msg) then F1itHTEAM = "المنشئ" elseif Manager(msg) then F1itHTEAM = "المدير" elseif Admin(msg) then F1itHTEAM = "الادمن" else F1itHTEAM = "العضو" end return F1itHTEAM end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1923405236) then F1itHTEAM = 'مبرمج سورس فايث' elseif tonumber(user_id) == tonumber(907887464) then F1itHTEAM = 'مبرمج فايث' elseif tonumber(user_id) == tonumber(426064076) then F1itHTEAM = 'فرخ فايث' elseif tonumber(user_id) == tonumber(F1itH) then F1itHTEAM = 'البوت' elseif SudoId(user_id) then F1itHTEAM = 'المطور الاساسي' elseif DevHii3d:sismember(F1itH..'Hii3d:SecondSudo:', user_id) then F1itHTEAM = 'المطور الثانوي' elseif DevHii3d:sismember(F1itH..'Hii3d:SudoBot:', user_id) then F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:SudoBot:Rd"..chat_id) or 'المطور' elseif DevHii3d:sismember(F1itH..'Hii3d:ManagerAll:', user_id) then F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:Managers:Rd"..chat_id) or 'المدير العام' elseif DevHii3d:sismember(F1itH..'Hii3d:AdminAll:', user_id) then F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevHii3d:sismember(F1itH..'Hii3d:VipAll:', user_id) then F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevHii3d:sismember(F1itH..'Hii3d:Hii3dConstructor:'..chat_id, user_id) then F1itHTEAM = 'منشئ المجموعه' elseif DevHii3d:sismember(F1itH..'Hii3d:BasicConstructor:'..chat_id, user_id) then F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevHii3d:sismember(F1itH..'Hii3d:Constructor:'..chat_id, user_id) then F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevHii3d:sismember(F1itH..'Hii3d:Managers:'..chat_id, user_id) then F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:Managers:Rd"..chat_id) or 'المدير' elseif DevHii3d:sismember(F1itH..'Hii3d:Admins:'..chat_id, user_id) then F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:Admins:Rd"..chat_id) or 'الادمن' elseif DevHii3d:sismember(F1itH..'Hii3d:VipMem:'..chat_id, user_id) then  F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:VipMem:Rd"..chat_id) or 'المميز' elseif DevHii3d:sismember(F1itH..'Hii3d:Cleaner:'..chat_id, user_id) then  F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:Cleaner:Rd"..chat_id) or 'المنظف' else F1itHTEAM = DevHii3d:get(F1itH.."Hii3d:mem:Rd"..chat_id) or 'العضو' end return F1itHTEAM end
--     Source Twix     --
